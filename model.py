...
def example_data():
    ...
    pdx_place_one = Place(place_name='Saturday Market',
                          ...
                          date=datetime.datetime(2016, 7, 5, 0, 0), trip_id=1, cat_id='explore')
    pdx_place_two = Place(place_name='Blue Star Donuts',
                          ...
                          date=datetime.datetime(2016, 7, 5, 0, 0), trip_id=1, cat_id='eat')
    pdx_place_three = Place(place_name='Ace Hotel',
                            ...
                            date=datetime.datetime(2016, 7, 5, 0, 0), trip_id=1, cat_id='sleep')
    pdx_place_four = Place(place_name='Oregon Historical Society',
                           ...
                           date=datetime.datetime(2016, 7, 6, 0, 0), trip_id=1, cat_id='explore')
    pdx_place_five = Place(place_name='Pine State Biscuits',
                           ...
                           date=datetime.datetime(2016, 7, 6, 0, 0), trip_id=1, cat_id='eat')
    bcn_place_one = Place(place_name='Kirin Dim Sum',
                          ...
                          date=datetime.datetime(2016, 1, 21, 0, 0), trip_id=2, cat_id='eat')
    bcn_place_two = Place(place_name='Vancouver Library',
                          ...
                          date=datetime.datetime(2016, 1, 21, 0, 0), trip_id=2, cat_id='explore')
    tw_place_one = Place(place_name='Taiwan National Palace Museum',
                         ...
                         date=datetime.datetime(2016, 10, 1, 0, 0), trip_id=3, cat_id='explore')
    tw_place_two = Place(place_name='Kaohsiung Station',
                         ...
                         date=datetime.datetime(2016, 10, 2, 0, 0), trip_id=3, cat_id='transport')
    tw_place_three = Place(place_name='Din Tai Fung',
                           ...
                           date=datetime.datetime(2016, 10, 3, 0, 0), trip_id=3, cat_id='eat')
